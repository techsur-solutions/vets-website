    ...
    veteranInformation: {
      ...
      pages: {
        veteranInformation: {
          ...
          title: 'Veteran information',
          initialData: {},
          schema: {"title":"","description":"","type":"object","properties":{"Contact Of Information":{"type":"object","title":"Address Information","properties":{"DaytimeTelephoneNumber":{"type":"string","title":"DaytimeTelephoneNumber"},"MiddleName":{"type":"string","title":"MiddleName"},"GivenName":{"type":"string","title":"GivenName"},"Unit[1]  Select Floor":{"type":"boolean","title":"Unit[1]  Select Floor"}}}}},
          uiSchema: {"DaytimeTelephoneNumber":{"ui:emptyValue":"","ui:autocomplete":"DaytimeTelephoneNumber"},"MiddleName":{"ui:emptyValue":"","ui:autocomplete":"MiddleName"},"GivenName":{"ui:emptyValue":"","ui:autocomplete":"GivenName"},"Unit[1]  Select Floor":{"ui:emptyValue":"","ui:autocomplete":"Unit[1]  Select Floor"}},
